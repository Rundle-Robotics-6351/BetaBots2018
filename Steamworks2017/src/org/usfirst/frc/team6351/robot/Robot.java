...
//        visionThread.start();
		...
		autoMode.addObject("Auto: Position 1 (UNTESTED)", new StartStation1Red());
		autoMode.addObject("Auto: Position 2 (UNTESTED)", new StartStation2Red());
		autoMode.addObject("Auto: Position 3 (UNTESTED)", new StartStation3Red());
